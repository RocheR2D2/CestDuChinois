...
$(document).ready(function () {
    ...
    $collectionHolder.data('index', $collectionHolder.find('.sous-panel').length);
    // finds all the panels in the list and foreach one of them we add a remove button to it
    // add remove button to existing items
    $collectionHolder.find('.sous-panel').each(function () {
...
function addRemoveButton ($panel) {
    ...
    var $removeButton = $('<a href="#" class="btn btn-xs">Remove</a>');
    ...
    $removeButton.click(function (e) {
        ...
        $(e.target).parents('.sous-panel').slideUp(1000, function () {
            $(this).remove();
        })
    });
}

function addHidePanelButton() {
